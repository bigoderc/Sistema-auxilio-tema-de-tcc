                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    <div class="form-group{{ $errors->has('fantasia') ? ' has-danger' : '' }}">
                                        ...
                                        <input type="text" name="cpf" id="input-fantasia" class="form-control form-control-alternative{{ $errors->has('fantasia') ? ' is-invalid' : '' }}" placeholder="{{ __('Matricula') }}" value="{{ old('fantasia',$aluno->cpf) }}" required>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col">
                                    <div class="form-group{{ $errors->has('fantasia') ? ' has-danger' : '' }}">
                                        ...
                                        <input type="text" name="turma" id="input-fantasia"
                                            ...
                                            placeholder="{{ __('Turma') }}" value="{{ old('fantasia',$aluno->turma) }}" required>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="form-group{{ $errors->has('fantasia') ? ' has-danger' : '' }}">
                                        ...
                                        <input type="text" maxlength="1" name="periodo" id="input-fantasia"
                                            class="form-control form-control-alternative{{ $errors->has('fantasia') ? ' is-invalid' : '' }}"
                                            placeholder="{{ __('Período') }}" value="{{ old('fantasia',$aluno->periodo) }}" required>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="form-group{{ $errors->has('fantasia') ? ' has-danger' : '' }}">
