...
@section('content')
    @include('users.partials.header', [
        ...
        'description' => __('Esta é a sua página de perfil. Você pode ver suas informações e alterar a mesma.'),
        'class' => 'col-lg-7'
    ])   
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-3 order-lg-2">
                            <div class="card-profile-image">
                                <a href="#">
                                    <!-- <img src="{{ asset('argon') }}/img/theme/team-4x800.jpg" title="Foto do usuario" class="rounded-circle"> -->
                                </a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body pt-0 pt-md-4">
                        ...
                        <div class="text-center">
                            ...
                            <div class="h5 font-weight-300">
                                <i class="ni location_pin mr-2"></i>{{ __( auth()->user()->endereco.' - '. auth()->user()->cidade) }}
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group{{ $errors->has('endereco') ? ' has-danger' : '' }}">
                                        ...
                                        <input type="text" name="endereco" id="input-endereco" class="form-control form-control-alternative{{ $errors->has('endereco') ? ' is-invalid' : '' }}" placeholder="{{ __('Endereço') }}" value="{{ old('endereco', auth()->user()->endereco) }}" >
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="form-group{{ $errors->has('numero') ? ' has-danger' : '' }}">
                                        <label class="form-control-label" for="input-numero">{{ __('Número') }}</label>
                                        <input type="text" name="numero" id="input-numero" class="form-control form-control-alternative{{ $errors->has('numero') ? ' is-invalid' : '' }}" placeholder="{{ __('Número') }}" value="{{ old('numero', auth()->user()->numero) }}" >
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="form-group{{ $errors->has('cep') ? ' has-danger' : '' }}">
                                        <label class="form-control-label" for="input-cep">{{ __('CEP') }}</label>
                                        <input type="text" name="cep" id="input-cep" class="form-control form-control-alternative{{ $errors->has('cep') ? ' is-invalid' : '' }}" placeholder="{{ __('CEP') }}" value="{{ old('cep', auth()->user()->cep) }}" >
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="form-group{{ $errors->has('cidade') ? ' has-danger' : '' }}">
                                        <label class="form-control-label" for="input-cidade">{{ __('Cidade') }}</label>
                                        <input type="text" name="cidade" id="input-cidade" class="form-control form-control-alternative{{ $errors->has('cidade') ? ' is-invalid' : '' }}" placeholder="{{ __('Cidade') }}" value="{{ old('cidade', auth()->user()->cidade) }}" >
                                    </div>
                                </div>
                                <div class="col-md-1">
                                    <div class="form-group{{ $errors->has('uf') ? ' has-danger' : '' }}">
                                        <label class="form-control-label" for="input-uf">{{ __('UF') }}</label>
                                        <input type="text" name="uf" id="input-uf" class="form-control form-control-alternative{{ $errors->has('uf') ? ' is-invalid' : '' }}" placeholder="{{ __('UF') }}" value="{{ old('uf', auth()->user()->uf) }}" >
                                    </div>
                                </div>
                            </div>
                                <div class="text-center">
